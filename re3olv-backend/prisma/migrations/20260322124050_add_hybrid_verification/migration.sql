...
CREATE TABLE "new_Case" (
    ...
    "founderName" TEXT,
    "founderImpact" TEXT,
    "verificationMethod" TEXT NOT NULL DEFAULT 'OFFICIAL_REGISTER',
    "lastFiscalUpdate" DATETIME,
    "verifiedRevenue" REAL NOT NULL DEFAULT 0,
...
INSERT INTO "new_Case" ("batchUploadId", "borrowerName", "createdAt", "creditScore", "encryptedData", "founderImpact", "founderName", "hardshipReason", "id", "isFeeFrozen", "isSME", "isVerified", "lastNudgedAt", "lastViewedAt", "magicLinkCreatedAt", "magicToken", "nextFollowUp", "organizationId", "paidAmount", "penaltyWaived", "principalAmount", "selectedOptionId", "settledAt", "status", "totalAmount", "updatedAt", "viewCount") SELECT "batchUploadId", "borrowerName", "createdAt", "creditScore", "encryptedData", "founderImpact", "founderName", "hardshipReason", "id", "isFeeFrozen", "isSME", "isVerified", "lastNudgedAt", "lastViewedAt", "magicLinkCreatedAt", "magicToken", "nextFollowUp", "organizationId", "paidAmount", "penaltyWaived", "principalAmount", "selectedOptionId", "settledAt", "status", "totalAmount", "updatedAt", "viewCount" FROM "Case";
DROP TABLE "Case";
