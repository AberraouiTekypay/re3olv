...
CREATE TABLE "BatchUpload" (
    ...
    CONSTRAINT "BatchUpload_organizationId_fkey" FOREIGN KEY ("organizationId") REFERENCES "Organization" ("id") ON DELETE RESTRICT ON UPDATE CASCADE
);
...
INSERT INTO "new_Case" ("borrowerName", "createdAt", "creditScore", "encryptedData", "hardshipReason", "id", "isFeeFrozen", "isVerified", "lastViewedAt", "magicLinkCreatedAt", "magicToken", "nextFollowUp", "organizationId", "paidAmount", "penaltyWaived", "principalAmount", "selectedOptionId", "settledAt", "status", "totalAmount", "updatedAt", "viewCount") SELECT "borrowerName", "createdAt", "creditScore", "encryptedData", "hardshipReason", "id", "isFeeFrozen", "isVerified", "lastViewedAt", "magicLinkCreatedAt", "magicToken", "nextFollowUp", "organizationId", "paidAmount", "penaltyWaived", "principalAmount", "selectedOptionId", "settledAt", "status", "totalAmount", "updatedAt", "viewCount" FROM "Case";
DROP TABLE "Case";
